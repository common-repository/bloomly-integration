...
class Ezoic_Integration_Cache_Identifier {
    ...
    public function ModifyAdvancedCache() {
        ...
        $ezoicContent = array("#BEGIN_EZOIC_INTEGRATION_PHP_CACHE_HANDLER",
            ...
            '   $ezoic_factory = new Bloomly_Namespace\Ezoic_Integration_Factory();',
            '   $ezoic_integrator = $ezoic_factory->NewEzoicIntegrator(Bloomly_Namespace\Ezoic_Cache_Type::PHP_CACHE);' ,
